...
class soldier:
    ...
    Input:
    Precondition:
    Postcondition: instantiate an soldier object
    Return:
    ...
    '''
    def __str__(self):
        string = str("This unit is soldier " + "Life: " + str(self.life) + " Experience: " + str(self.exp))
        return string
